      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Kathmandu, Nepal</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:xyz@gmail.com" className="d-block" >xyz@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:9998887776" className="d-block" >9998887776</a>
          </div>
        ...
        <p className="text-light">   @ 2024. xyz All rights reserved </p> 
        </Col>
        </Row>
